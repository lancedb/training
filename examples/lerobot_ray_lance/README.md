# LeRobot Diffusion Policy + Ray Train + LanceDB

Trains a LeRobot diffusion policy with Ray Train, using a Lance-backed dataset index for scalable sharding.
...
Main entrypoint: `examples/lerobot_ray_lance/ray_train_lerobot_lance.py`
