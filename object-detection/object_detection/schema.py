...
GENEVA_UDF_COLUMNS = [
    ...
    # Tier 3: dedup — dHash perceptual hash (GPU backfill).
    # 64-bit binary vector (0.0/1.0). L2² = Hamming distance for 0/1 vectors.
    # Build an L2 vector index after dhash backfill, then backfill is_duplicate.
    pa.field("dhash",         pa.list_(pa.float32(), 64)),
